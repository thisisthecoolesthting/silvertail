...
1. **Step height**: High rises strain already-stiff joints
2. **Traction**: Slick surfaces cause slips and fear
3. **Stability**: Lightweight models shift during use, creating negative associations
