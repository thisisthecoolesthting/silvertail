...
1) Appetite (percentage of normal)
2) Mobility (stairs attempted, distance walked)
3) Vocalizations (whining when moving)
...
1. **Veterinary Partnership**: Schedule monthly quality-of-life assessments
2. **Caregiver Support**: Join online communities like The Grey Muzzle Organization
3. **Memory Making**: Create pawprint keepsakes early in the process
4. **Emergency Plan**: Have after-hours vet numbers programmed
