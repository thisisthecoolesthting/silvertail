...
- **Texture variety**: Rotating between plush, rubber, and wooden toys decreased repetitive licking
- **Meal timing**: Feeding 3 smaller meals (vs. 2 large ones) reduced post-meal confusion episodes

## Cost math

Over a typical 3-year CCD journey:
...
- Prescription diets (20-50% coverage)
- Behavioral consults ($80-$200/session)
...
3. Interaction logs (initiation of play/contact)
